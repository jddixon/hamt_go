...
// current depth.
//
func (t32 *Table32) deleteEntry(hc uint64, depth uint, key Key64I) (
	err error) {
...
//
func (t32 *Table32) findEntry(hc uint64, depth uint, key Key64I) (
...
//
func (t32 *Table32) insertAtMatch(newHC uint64, depth uint, entry *Entry32,
...
//
func (t32 *Table32) insertEntry(hc uint64, depth uint, entry *Entry32) (
